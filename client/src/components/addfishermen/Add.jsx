                ...
                <div className="Fishermen_form-container">
                    ...
                    <form className="addFishermenForm" onSubmit={submitForm}>
                        ...
                        {/* <div className="inputGroup">
                            ...
                            <input type="text" onChange={inputHandler} id="trip" name="trip" autoComplete='off' placeholder="Enter trip duration"/>
                        </div> */}
                        <div className="Fishermen_inputGroup">
                        ...
                        <div className="Fishermen_inputGroup">
                            ...
                            {/* <input type="text" onChange={inputHandler} id="availability" name="availability" autoComplete='off' placeholder="Yes / No"/> */}
